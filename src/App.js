    ...
    <Suspense maxDuration={100} fallback={<div>Loading...</div>}>
      <div className="App">
        {toggle ? (
          <React.Fragment>
            <span>
              Driven by URL: <PaginatorWithUrl getPageContent={getPageContent} totalPages={10} />
            </span>
            <button
              onClick={() => {
                setToggle(!toggle)
            ...
            >
              Switch to internal state driven
            </button>
          </React.Fragment>
        ) : (
          <React.Fragment>
            <span>
              Driven by internal state: <Paginator getPageContent={getPageContent} totalPages={10} />
            </span>
